        ...
        div.innerHTML = `
          <div style="background:rgba(3,19,31,0.92);padding:10px 12px;border-radius:8px;border:1px solid rgba(49,215,255,0.3);font-size:10px;color:#94a3b8;font-family:'IBM Plex Mono',monospace;">
            ...
            <div style="display:flex;flex-direction:column;gap:4px;">
              ...
              <span style="margin-top:2px;">🏥 Ebola Treatment Units</span>
            </div>
          </div>
        `;
        return div;
  ...
  return (
    <div className="dashboard-overview">
      <div className="overview-stats-grid">
        ...
        <div className="overview-stat-card stat-info" title="Ebola outbreak cases tracked from WHO, CDC, Africa CDC, and country health authorities">
          <div className="stat-card-icon">🔬</div>
          <div className="stat-card-content">
            ...
            <div className="stat-card-source">WHO, CDC, Africa CDC</div>
          </div>
        </div>
        <div className="overview-stat-card stat-critical" title="Total confirmed deaths from Ebola across all known outbreaks (1976–present)">
          <div className="stat-card-icon">💀</div>
          <div className="stat-card-content">
            <div className="stat-card-value">{HISTORICAL_OUTBREAKS.reduce((s, o) => s + o.totalDeaths, 0).toLocaleString()}</div>
            <div className="stat-card-label">All-Time Deaths</div>
            <div className="stat-card-source">31 known outbreaks since 1976</div>
          </div>
        </div>
        <div className="overview-stat-card stat-info" title="Medical evacuation flights tracked via OpenSky Network">
        ...
        <div className="overview-stat-card stat-info" title="Countries with active news signals or Ebola case reports">
          <div className="stat-card-icon">🌍</div>
          <div className="stat-card-content">
        ...
        <div className="overview-stat-card stat-info" title="Passengers in quarantine across affected countries with 21-day isolation protocols">
          <div className="stat-card-icon">🏥</div>
          <div className="stat-card-content">
      ...
      <div className="overview-two-col">
        ...
        <div className="overview-panel">
          ...
          <div className="overview-geo-section">
            <div className="geo-section-title">🔴 Countries with Active Ebola Cases</div>
            ...
            <div className="geo-section-title" style={{ marginTop: 12 }}>🟠 Endemic Ebola Regions</div>
            <div className="overview-geo-list">
              {[
            ...
            <div className="geo-section-title" style={{ marginTop: 12 }}>🟡 Possible Affected (Contact Tracing)</div>
            <div className="overview-geo-list">
              {[
