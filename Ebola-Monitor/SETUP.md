...
EpiTrace is a real-time Ebola Virus Disease (EVD) monitoring dashboard that aggregates public-source disease signals from RSS feeds, news APIs, and official health authority websites. It provides situational awareness for EVD outbreak tracking with AI-assisted analysis.
...
```bash
# Create database
createdb ebola_monitor

# Update DATABASE_URL in .env
DATABASE_URL=postgresql://user:password@localhost:5432/ebola_monitor
...
2. Query NewsAPI for Ebola-related articles
...
```json
{
  ...
  "latest": [
    {
      "id": "HT-0001",
      "title": "Ebola Virus Disease Outbreak...",
