        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((item, idx) => {
            const newsArticleSchema = {
              ...
              image: {
                "@type": "ImageObject",
                url: `${typeof window !== "undefined" ? window.location.origin : "https://www.hantavirusmonitorapp.com"}/opengraph-image`,
              },
              articleSection: "Health",
              keywords: ["hantavirus", item.country, item.severity],
              about: {
                "@type": "Thing",
                name: "Hantavirus outbreak — 2026",
              },
              inLanguage: "en",
            };
