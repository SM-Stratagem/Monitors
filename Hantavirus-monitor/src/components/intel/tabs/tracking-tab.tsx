...
const REPATRIATION_FLIGHTS: Flight[] = [
  {
    ...
    arrivedTime: "Arrived",
    sources: [
      { text: "AP — Plane carrying Spanish passengers from hantavirus ship", url: "https://www.2news.com" }
    ]
  },
  {
    id: "fr",
  ...
  },
  {
    ...
    arrivedTime: "Arrived",
    sources: [
      { text: "AP — MV Hondius evacuation coverage", url: "https://www.2news.com" }
    ]
  },
  {
    id: "nl",
  ...
  },
  {
    ...
    sources: [
      { text: "CBC — Hantavirus cruise ship evacuation", url: "https://www.cbc.ca" }
    ]
  },
  {
    id: "tr",
