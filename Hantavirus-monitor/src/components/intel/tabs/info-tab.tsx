  ...
  return (
    <div className="info-tab">
      ...
      <div className="info-section">
        <h3>📡 About HantaTrack</h3>
        <p>
          HantaTrack is an unofficial real-time intelligence dashboard that aggregates 
          public-source disease signals for situational awareness. It is not affiliated 
      ...
      <div className="info-section">
        ...
        <div className="info-links">
          ...
          <a href="https://www.cdc.gov/hantavirus/" target="_blank" rel="noreferrer" className="info-link">
            <span className="info-link-icon">🇺🇸</span>
            <div className="info-link-text">
              <strong>CDC - Hantavirus</strong>
              <span>US Centers for Disease Control</span>
            </div>
            <span className="info-link-arrow">↗</span>
          </a>
          <a href="https://www.ecdc.europa.eu" target="_blank" rel="noreferrer" className="info-link">
            <span className="info-link-icon">🇪🇺</span>
            <div className="info-link-text">
              <strong>ECDC</strong>
              <span>European Centre for Disease Prevention</span>
            </div>
            <span className="info-link-arrow">↗</span>
          </a>
          <a href="https://news.google.com/rss/search?q=hantavirus" target="_blank" rel="noreferrer" className="info-link">
            <span className="info-link-icon">📰</span>
            <div className="info-link-text">
      ...
      <div style={{ textAlign: "center", padding: "16px", color: "#64748b", fontSize: "11px" }}>
        HantaTrack | Built for public health awareness | Data may be delayed or incomplete
      </div>
    </div>
  );
}
