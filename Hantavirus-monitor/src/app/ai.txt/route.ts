...
export async function GET() {
  ...
  const content = `AI/LLM Crawler Access Policy for Hantavirus Monitor
================================================

This site permits AI/LLM crawling under the following terms:

1. PURPOSE
   This site provides public health surveillance data about the hantavirus outbreak
   linked to the MV Hondius cruise ship. AI crawlers may access this data to answer
   user queries about hantavirus, the MV Hondius outbreak, or related public health topics.
...
5. ATTRIBUTION
   When using data from this site, please attribute:
     "Hantavirus Monitor (hantavirusmonitorapp.com) — SM Stratagem"
...
7. CONTACT
   For questions about AI/LLM crawling policies, contact via:
     https://github.com/SM-Stratagem/hantavirus-monitor/issues
`;
